...
void Loading() {
  int x = 3;
  int y = 37;
  tft.drawBitmap(x, y, Loading1, 170, 147);
  delay(75);
  tft.drawBitmap(x, y, Loading2, 170, 147);
  delay(75);
  tft.drawBitmap(x, y, Loading3, 170, 147);
  delay(75);
  tft.drawBitmap(x, y, Loading4, 170, 147);
  delay(75);
  tft.drawBitmap(x, y, Loading5, 170, 147);
  delay(75);
  tft.drawBitmap(x, y, Loading6, 170, 147);
  delay(75);
  tft.drawBitmap(x, y, Loading7, 170, 147);
  delay(75);
  tft.drawBitmap(x, y, Loading8, 170, 147);
  delay(75);
  tft.drawBitmap(x, y, Loading9, 170, 147);
  delay(75);
  tft.drawBitmap(x, y, Loading10, 170, 147);
  delay(75);
  tft.drawBitmap(x, y, Loading11, 170, 147);
  delay(75);
  tft.drawBitmap(x, y, Loading12, 170, 147);
  delay(75);
  tft.drawBitmap(x, y, Loading13, 170, 147);
  delay(75);
  tft.drawBitmap(x, y, Loading14, 170, 147);
  delay(75);
  tft.drawBitmap(x, y, Loading15, 170, 147);
  delay(75);
  tft.drawBitmap(x, y, Loading16, 170, 147);
  delay(75);
  tft.drawBitmap(x, y, Loading17, 170, 147);
  delay(75);
  tft.drawBitmap(x, y, Loading18, 170, 147);
  delay(75);
  tft.drawBitmap(x, y, Loading19, 170, 147);
  delay(75);
  tft.drawBitmap(x, y, Loading20, 170, 147);
  delay(75);
  tft.drawBitmap(x, y, Loading21, 170, 147);
  delay(75);
  tft.drawBitmap(x, y, Loading22, 170, 147);
  delay(75);
  tft.drawBitmap(x, y, Loading23, 170, 147);
  delay(75);
  tft.drawBitmap(x, y, Loading24, 170, 147);
  delay(75);
  tft.drawBitmap(x, y, Loading25, 170, 147);
  delay(75);
  tft.drawBitmap(x, y, Loading1, 170, 147);
  delay(75);
  tft.drawBitmap(x, y, Loading2, 170, 147);
...
void Draw_map1() {
  ...
  //tft.drawLine(20, 89, 60, 89, COLOR_GRAY);
  //tft.drawLine(115, 89, 155, 89, COLOR_GRAY);
...
void Print_Localtime() {
  ...
  if (rtcSynced) {
    ...
    getPhase(yy, mm, dd);
      ...
      //Set Alarm 
    if (rtcTime.hour() == 14 && rtcTime.minute() >= 30 && rtcTime.minute() < 31) {
...
void getPhase(int Y, int M, int D) {  
  ...
  if(AG < 1.20369)
    tft.drawBitmap(x, y, Phase0, 50, 50);

  else if(AG < 3.61108)
    tft.drawBitmap(x, y, Phase1, 50, 50);

  else if(AG < 6.01846)
    tft.drawBitmap(x, y, Phase2, 50, 50);

  else if(AG < 8.42595)
    tft.drawBitmap(x, y, Phase3, 50, 50);

  else if(AG < 10.83323)
    tft.drawBitmap(x, y, Phase4, 50, 50);

  else if(AG < 13.24062)
    tft.drawBitmap(x, y, Phase5, 50, 50);

  else if(AG < 15.64800)
    tft.drawBitmap(x, y, Phase6, 50, 50);

  else if(AG < 18.05539)
    tft.drawBitmap(x, y, Phase7, 50, 50);

  else if(AG < 20.46277)
    tft.drawBitmap(x, y, Phase8, 50, 50);

  else if(AG < 22.87016)
    tft.drawBitmap(x, y, Phase9, 50, 50);

  else if(AG < 25.27754)
    tft.drawBitmap(x, y, Phase10, 50, 50);

  else if(AG < 27.68493)
    tft.drawBitmap(x, y, Phase11, 50, 50);
...
void API_Weather() {
  if (WiFi.status() == WL_CONNECTED) {
    ...
    if (httpCode > 0) {
      if (httpCode == HTTP_CODE_OK) {
        ...
        if (icon == "01d") {
          tft.drawBitmap(x, y, clear_sky_day, 64, 64);
        }

        else if(icon == "01n") {
          tft.drawBitmap(x, y, clear_sky_night, 64, 64);
        }

        else if(icon == "02d") {
          tft.drawBitmap(x, y, few_clouds_day, 64, 64);
        }

        else if(icon == "02n") {
          tft.drawBitmap(x, y, few_clouds_night, 64, 64);
        }

        else if(icon == "03d") {
          tft.drawBitmap(x, y, scattered_clouds_day, 64, 64);
        }

        else if(icon == "03n") {
          tft.drawBitmap(x, y, scattered_clouds_night, 64, 64);
        }

        else if(icon == "04d" || icon == "04n") {
          tft.drawBitmap(x, y, broken_clouds, 64, 64);
        }

        else if(icon == "09d" || icon == "10d") {
          tft.drawBitmap(x, y, rain_day, 64, 64);
        }

        else if(icon == "09n" || icon == "10n") {
          tft.drawBitmap(x, y, rain_night, 64, 64);
        }

        else if(icon == "11d") {
          tft.drawBitmap(x, y, thunderstorm, 64, 64);
        }
  ...
  http.end();
    ...
    tft.drawBitmap(z, p, Disconnect1, 91, 70);
    delay(200);
    tft.drawBitmap(z, p, Disconnect2, 91, 70);
    delay(200);
    tft.drawBitmap(z, p, Disconnect3, 91, 70);
    delay(200);
    tft.drawBitmap(z, p, Disconnect4, 91, 70);
    delay(200);
    tft.drawBitmap(z, p, Disconnect5, 91, 70);
    delay(200);
    tft.drawBitmap(z, p, Disconnect6, 91, 70);
    delay(200);
    tft.drawBitmap(z, p, Disconnect7, 91, 70);
    delay(200);
    tft.drawBitmap(z, p, Disconnect8, 91, 70);
    delay(200);
    tft.drawBitmap(z, p, Disconnect9, 91, 70);
    delay(200);
    tft.drawBitmap(z, p, Disconnect10, 91, 70);
    delay(200);
    tft.drawBitmap(z, p, Disconnect11, 91, 70);
    delay(200);
    tft.drawBitmap(z, p, Disconnect12, 91, 70);
    delay(200);
    tft.drawBitmap(z, p, Disconnect13, 91, 70);
    delay(200);
    tft.drawBitmap(z, p, Disconnect14, 91, 70);
    delay(200);
    ...
    if (httpCode1 > 0) {
      if (httpCode1 == HTTP_CODE_OK) {
        ...
        int y = 32;
          ...
          //Draw Weather icons
        if (main == "Clear") {
          tft.drawBitmap(x, y, clear, 45, 45);
        }
        else if (main == "Clouds") {
          tft.drawBitmap(x, y, clouds, 45, 45);
        }
        else if (main == "Rain") {
          tft.drawBitmap(x, y, rain, 45, 45);
        }
        else if (main == "Thunderstorm") {
          tft.drawBitmap(x, y, thunder, 45, 45);
        }
      } 
      else {
      Serial.println("Error on HTTP request");
